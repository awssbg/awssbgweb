...
for (const required of ['certification-practice.html', 'certification-services.js', 'certification-cloud-flow.js', 'certification-auth.css', 'supabase-public-config.js']) assert(shipped.includes(required), `${required} is missing from production build`);
